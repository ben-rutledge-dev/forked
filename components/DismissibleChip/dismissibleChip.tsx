...
export const DismissibleChip = ({
  ...
  <div className="group relative inline-flex items-center">
    <button
      ...
      onClick={onToggle}
      disabled={disabled}
      className={selected ? CHIP_ACTIVE_CLASS : CHIP_INACTIVE_CLASS}
    >
      {label}
    ...
    {!selected && (
      <button
        ...
        onClick={onSkip}
        disabled={disabled}
        className="absolute right-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity text-stone-400 hover:text-stone-600"
