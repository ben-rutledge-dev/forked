...
export const SmallCheckIcon: React.FC<IconProps> = (props) => {
  const { className } = props;
  return (
...
export const StopSquareIcon: React.FC<IconProps> = (props) => {
  const { className } = props;
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
...
export const ForkBrandIcon: React.FC<IconProps> = (props) => {
  const { className } = props;
  return (
