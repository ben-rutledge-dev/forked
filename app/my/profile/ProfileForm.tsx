...
export function ProfileForm({ user }: { user: UserProfile }) {
  ...
  async function handleAvatarChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try { setAvatarUrl(await uploadImage(file)); }
  ...
  async function handleCoverChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    catch { setError("Cover photo upload failed"); }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          {coverImageUrl ? (
            <div className="relative inline-block">
              <img src={coverImageUrl} alt="Cover" className="w-full h-32 rounded-xl object-cover border border-stone-200" />
              <CornerDeleteButton
        ...
        <div className="flex items-center gap-4">
          <div className="relative shrink-0">
            {avatarUrl ? (
              <>
                <img src={avatarUrl} alt="Avatar" className="w-16 h-16 rounded-full object-cover border border-stone-200" />
                <CornerDeleteButton
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="username" className="block text-sm font-medium text-stone-700 mb-1">Username <span className="text-stone-400 font-normal">(required to have a public profile)</span></label>
